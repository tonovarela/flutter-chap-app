...
final usuarios = [
    Usuario( uuid: '1',nombre :'Maria',email:"test1@email.com",online: true),
    Usuario( uuid: '2',nombre :'Valeria',email:"test2@email.com",online: false),
    Usuario( uuid: '3',nombre :'Melissa',email:"test1@email.com",online: true)
];
